...
class Alligator extends Animal {
  ...
  eats0() {
    // call method of parent class forexample.
    super.eats();
  }
  eats() {
    // redefining base method (polymorphysm)

    console.log(
      this.name + " eats fish because redefined method using polymorphysm"
    );
  }
}
